...
from priority_lens.api.middleware import (
    setup_cors,
...
def create_app(config: APIConfig | None = None) -> FastAPI:
    ...
    from priority_lens.api.routes import inbox_router, projects_router, tasks_router
...
def run_server(config: APIConfig | None = None) -> None:
    ...
    uvicorn.run(
        "priority_lens.api.main:create_app",
        factory=True,
        host=config.host,
        port=config.port,
