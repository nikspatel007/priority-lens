...
DEFAULT_LOG_FILE = "rl_emails.log"
...
def setup_logging(
    ...
    Args:
        ...
        log_file: Name of log file (default: rl_emails.log).
    ...
    Returns:
        Root logger for rl_emails package.
    """
    # Get the root logger for our package
    logger = logging.getLogger("rl_emails")
...
def get_logger(name: str) -> logging.Logger:
    ...
    Args:
        name: Module name (will be prefixed with rl_emails).

    Returns:
        Logger instance.
    """
    if name.startswith("rl_emails"):
        return logging.getLogger(name)
    return logging.getLogger(f"rl_emails.{name}")
