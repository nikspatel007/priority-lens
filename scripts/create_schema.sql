...
DROP TABLE IF EXISTS human_task_labels CASCADE;
DROP TABLE IF EXISTS priority_contexts CASCADE;
DROP TABLE IF EXISTS email_project_links CASCADE;
DROP TABLE IF EXISTS projects CASCADE;
DROP TABLE IF EXISTS email_llm_features CASCADE;
DROP TABLE IF EXISTS email_embeddings CASCADE;
DROP TABLE IF EXISTS tasks CASCADE;
DROP TABLE IF EXISTS email_features CASCADE;
